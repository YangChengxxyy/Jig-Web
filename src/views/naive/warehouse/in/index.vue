    ...
    <el-form ref="form" :model="sel_form" label-width="80px" label-position="left" style="margin-top: 2%">
      ...
      <el-row :gutter="20">
        <el-col :span="11" :offset="12">
          ...
          <el-link :href="onePage" target="_blank" :disabled="outgoing_jig_list.length === 0"><el-button :disabled="outgoing_jig_list.length === 0">导出本页</el-button></el-link>
          <el-link :href="allPage" target="_blank" :disabled="outgoing_jig_list.length === 0"><el-button :disabled="outgoing_jig_list.length === 0">导出全部</el-button></el-link>
        </el-col>
      </el-row>
    </el-form>
    <el-divider />
